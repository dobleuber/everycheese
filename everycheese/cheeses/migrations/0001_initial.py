    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('firmness', models.CharField(choices=[('unspecified', 'Unspecified'), ('soft', 'Soft'), ('semi-soft', 'Semi-soft'), ('semi-hard', 'Semi-Hard'), ('hard', 'Hard')], default='unspecified', max_length=200, verbose_name='Firmness')),
            ],
            options={
                'abstract': False,
            },
